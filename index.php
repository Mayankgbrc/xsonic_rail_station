...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>Xsonic Live Station | Live Stations of Indian Railway</title>
...
<body >
    ...
    <div class="w3-container">
        ...
        ?>
        <h3>Enter Station name or code: </h3>
        ...
        <form method="get" action="buffer.php">
            <input type="hidden" name="station_name" id="out"/>
